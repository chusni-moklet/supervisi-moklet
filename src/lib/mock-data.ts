    ...
    indicators: [
      {
        ...
        categoryId: "cat1",
        number: 1,
        text: "Guru menyampaikan salam dan mengecek kehadiran siswa",
      },
      {
        id: "ind2",
        categoryId: "cat1",
        number: 2,
        text: "Guru menyampaikan tujuan pembelajaran yang akan dicapai",
      },
      {
        id: "ind3",
        categoryId: "cat1",
        number: 3,
        text: "Guru memberikan apersepsi/motivasi untuk memulai pembelajaran",
      },
    ],
  },
  {
    ...
    indicators: [
      {
        ...
        categoryId: "cat2",
        number: 4,
        text: "Guru menguasai materi pelajaran yang disampaikan",
      },
      {
        id: "ind5",
        categoryId: "cat2",
        number: 5,
        text: "Guru menggunakan metode/model pembelajaran yang sesuai",
      },
      {
        id: "ind6",
        categoryId: "cat2",
        number: 6,
        text: "Guru menggunakan media/alat pembelajaran yang efektif",
      },
      {
        id: "ind7",
        categoryId: "cat2",
        number: 7,
        text: "Guru melibatkan siswa secara aktif dalam proses pembelajaran",
      },
      {
        id: "ind8",
        categoryId: "cat2",
        number: 8,
        text: "Guru memberikan umpan balik yang konstruktif kepada siswa",
      },
    ],
  },
  {
    ...
    indicators: [
      {
        ...
        categoryId: "cat3",
        number: 9,
        text: "Guru membimbing siswa menyimpulkan materi pembelajaran",
      },
      {
        id: "ind10",
        categoryId: "cat3",
        number: 10,
        text: "Guru memberikan tugas/tindak lanjut dan menyampaikan rencana pembelajaran berikutnya",
      },
    ],
  },
];

export const ALL_INDICATORS = MOCK_INDICATOR_CATEGORIES.flatMap(
  (c) => c.indicators,
);
...
export const MOCK_SCHEDULES: Schedule[] = [
  {
    id: "s1",
    teacherId: "t9",
    teacherName: "Lina Marlina, S.Pd.",
    department: "Hubinkom",
    observerId: "u1",
    observerName: "Chusni Mubarok",
    date: "2026-06-25",
    status: "Terjadwal",
  },
  {
  ...
  },
  {
    id: "s4",
    teacherId: "t14",
    teacherName: "Rizky Aditya, S.Kom.",
    department: "QDPM",
    observerId: "u3",
    observerName: "Siti Rahmawati",
    date: "2026-07-01",
...
export const MOCK_DASHBOARD_STATS: DashboardStats = {
  ...
  belumSupervisi:
    ...
    MOCK_OBSERVATIONS.length -
    MOCK_SCHEDULES.filter((s) => s.status === "Terjadwal").length,
};
