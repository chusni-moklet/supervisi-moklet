    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100 px-4">
      ...
      <div className="w-full max-w-[420px] animate-fade-in-up relative">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-800">Supervisi Moklet</h1>
        ...
        <div className="card p-6 sm:p-8">
          ...
          <div className="space-y-4">
            {/* Error Message */}
            {authError && (
              <div className="p-3 rounded-lg bg-red-50 border border-red-200 text-sm text-red-600 animate-fade-in text-center">
                {authError}
              </div>
            )}
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 font-medium py-2.5 px-4 rounded-xl transition-colors"
            >
